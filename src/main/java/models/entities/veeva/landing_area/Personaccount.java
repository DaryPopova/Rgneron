...
public class Personaccount {
    ...
    @Column(name = "Gender_vod__c")
    public String GenderVodC;

    @Column(name = "Primary_Parent_vod__c")
    public String PrimaryParentVodC;

    @Column(name = "NPI_vod__c")
    public String NPIVodC;

    @Column(name = "Credentials_vod__c")
    public String CredentialsVodC;
    ...
    @Column(name = "Middle_vod__c")
    public String MiddleVodC;

    @Column(name = "Phone")
    public String Phone;

    @Column(name = "Specialty_1_vod__c")
    public String Specialty1VodC;
    ...
    @Column(name = "Preferred_Name_vod__c")
    public String PreferredNameVodC;
    ...
    @Column(name = "REG_AMA_No_Contact__c")
    public String REGAMANoContactC;

    @Column(name = "PDRP_Opt_Out_vod__c")
    public String PDRPOptOutVodC;

    @Column(name = "PDRP_Opt_Out_Date_vod__c")
    public String PDRPOptOutDateVodC;

    @Column(name = "REG_Credential_Type__c")
    public String REGCredentialTypeC;

    @Column(name = "REG_Suffix__c")
    public String REGSuffixC;

    @Column(name = "REG_Title__c")
    public String REGTitleC;
    ...
    @Column(name = "REG_of_Patients_on_a_Generic_Biosimilar__c")
    public String REGOfPatientsOnAGenericBiosimilarC;

    @Column(name = "REG_of_Patients_on_Biologic_Agents__c")
    public String REGOfPatientsOnBiologicAgentsC;

    @Column(name = "REG_Competition_Speaker__c")
    public String REGCompetitionSpeakerC;

    @Column(name = "REG_Regeneron_Speaker__c")
    public String REGRegeneronSpeakerC;
    ...
    @Column(name = "REG_Title_2__c")
    public String REGTitle2C;

    @Column(name = "REG_Title_3__c")
    public String REGTitle3C;

    @Column(name = "REG_Created_By_Profile_Name__c")
    public String REGCreatedByProfileNameC;

    @Column(name = "REG_Expert__c")
    public String REGExpertC;

    @Column(name = "REG_Last_Modified_by_Profile__c")
    public String REGLastModifiedByProfileC;

    @Column(name = "REG_MedPro_First_Name__c")
    public String REGMedProFirstNameC;

    @Column(name = "REG_MedPro_Last_Name__c")
    public String REGMedProLastNameC;

    @Column(name = "REG_MedPro_Designation__c")
    public String REGMedProDesignationC;

    @Column(name = "REG_DUPI_Attend_Speaker_Program__c")
    public String REGDUPIAttendSpeakerProgramC;

    @Column(name = "REG_DUPI_Part_of_National_Group__c")
    public String REGDUPIPartOfNationalGroupC;

    @Column(name = "REG_DUPI_Expert__c")
    public String REGDUPIExpertC;

    @Column(name = "REG_DUPI_of_Patients_on_Biologic_Agents__c")
    public String REGDUPIOfPatientsOnBiologicAgentsC;
    ...
    @Column(name = "REG_DERMATOLOGY_Opportunity_Ranking__c")
    public String REGDERMATOLOGYOpportunityRankingC;
